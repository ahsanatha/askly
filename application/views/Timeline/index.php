                ...
                <div class="sg-box__hole">
                    <div class="sg-actions-list sg-actions-list--to-top sg-actions-list--no-wrap">
                                            ...
                                            <ul class="sg-breadcrumb-list sg-breadcrumb-list--short">
                                                <li class="sg-breadcrumb-list__element">
                                                    <span class="sg-text sg-text--small sg-text--gray sg-text--bold">
                                                        <span class="sg-text sg-text--small sg-text--link sg-text--bold sg-text--gray">Biology</span>
                                                    </span>
                                                </li>
                                                <li class="sg-breadcrumb-list__element">
                                                     <!-- jadiin tanggal aja -->
                                                    <span class="sg-text sg-text--small sg-text--gray sg-text--bold">5 minutes ago</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="sg-content-box__content sg-content-box__content--full">
                            <div class="sg-actions-list sg-actions-list--to-top sg-actions-list--no-wrap">
                                <div class="sg-actions-list__hole sg-actions-list__hole--hide-overflow">
                                    <a data-test="feed-item-link" href="/question/12524274" class="sg-text sg-text--link-unstyled sg-text--bold">
                        ...
                        <div class="sg-actions-list__hole sg-actions-list__hole--to-right">
                            <!-- tombol jawab-->
                            <a href="#" class="sg-button-secondary sg-button-secondary--small sg-button-secondary--inverse">Answer</a>
                        </div>
                    </div>
                </div>
            </div>
