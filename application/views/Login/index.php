    ...
    <div class="sg-layout__content sg-hide-for-medium-down">
        <div class="sg-content-box">
            <div class="sg-content-box__title sg-content-box__title--spaced-top-large">
                <h1 class="sg-text-bit sg-text-bit--blue-secondary sg-text-bit--large">Hari ini <br> update <br> ilmu apa?</h1>
            </div>
        </div>
    </div>
                    ...
                    <div class="sg-content-box sg-content-box--spaced-bottom-large">
                        ...
                        <form>
                            <div class="sg-content-box__content sg-content-box__content--spaced-bottom">
                                <input type="text" class="sg-input sg-input--full-width" placeholder="Nama panggilan atau email " name="username" value="">
                            </div>
                            <div class="sg-content-box__content sg-content-box__content--spaced-bottom">
                                <input type="password" class="sg-input sg-input--full-width" placeholder="Kata sandi" name="password" value="">
                            </div>
                                ...
                                <div class="sg-actions-list">
                                    <div class="sg-actions-list__hole">
                                        <div class="sg-actions-list sg-actions-list--no-wrap">
                                            <div class="sg-actions-list__hole sg-actions-list__hole--container sg-actions-list__hole--no-shrink"><div class="sg-checkbox">
                                                <input class="sg-checkbox__element" type="checkbox" id="autoLogin" name="autoLogin" checked=""><label class="sg-checkbox__ghost" for="autoLogin">
                                        ...
                                        <div class="sg-actions-list__hole">
                                            <label for="autoLogin" class="sg-text sg-text--xsmall sg-text--gray sg-text--bold sg-text--justify">Saya ingin tetap masuk</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="sg-actions-list__hole sg-actions-list__hole--to-right">
                                    <a href="#" class="sg-text sg-text--xsmall sg-text--link sg-text--bold sg-text--blue-dark">Lupa kata sandi?</a>
                                </div>
                            </div>
                        </div>
                        <div class="sg-content-box__content sg-content-box__content--spaced-bottom-xlarge">
                            <button data-test="form-login-submit" class="sg-button-primary sg-button-primary--alt">Masuk</button>
                        </div>
                    </form>
                    <div class="sg-content-box__content">
                        <div class="sg-text sg-text--xsmall sg-text--gray sg-text--bold">Saya tidak memiliki akun, <a href="#" class="sg-text sg-text--xsmall sg-text--link sg-text--bold sg-text--blue-dark">mendaftar sekarang</a>. </div>
                    </div>
                </div>
            </div>
        </div>
