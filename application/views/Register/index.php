    ...
    <div class="sg-layout__container js-main-container sg-layout__container--reversed-order">
        ...
        <div class="sg-layout__aside-content">
            <div class="js-signup-react">
                <div data-test="authorization-form" class="sg-box sg-box--no-border sg-box--full">
                    <div class="sg-box__hole">
                        ...
                        <div id="tahap1" class="sg-content-box sg-content-box--full">
                            <div class="sg-content-box sg-content-box--spaced-bottom-large">
                                <div class="sg-content-box sg-content-box--spaced-bottom-small">
                                    <h1 class="sg-headline sg-headline--small sg-headline--to-left" id="formTitle">Buat
                                        akun di Askly!
                                    </h1>
                                </div>
                                <div class="sg-text sg-text--small sg-text--gray sg-text--to-left">Agan telah memiliki
                            ...
                            <div>
                                <button class="sg-button-primary sg-button-primary--full-width sg-button-primary--dark"
                                    id="btnEmail">
                                    Daftar dengan email
                                </button>
                            </div>
                        ...
                        <div id="tahap2" class="sg-content-box sg-content-box--full">
                            <div class="sg-content-box sg-content-box--spaced-bottom-large">
                                <div class="sg-content-box sg-content-box--spaced-bottom-small">
                                    <h1 class="sg-headline sg-headline--small sg-headline--to-left">Daftar dengan email
                                    </h1>
                                </div>
                                <div class="sg-text sg-text--small sg-text--gray sg-text--to-left">Agan telah memiliki
                                    akun? <span data-test="form-login-link"
                        ...
                        <div id="tahap3" class="sg-content-box sg-content-box--full">
                            ...
                            <div class="sg-content-box sg-content-box--spaced-bottom">
                                <div class="sg-content-box"><label for="nick"
                                        class="sg-text sg-text--xsmall sg-text--bold sg-text--container">Nama panggilan
                                        <div class="brn-required-mark">*</div></label></div><input type="text"
                                    class="sg-input sg-input sg-input--full-width" placeholder="Pilih nama panggilan"
                                    name="nick">
                            </div>
                            <div class="sg-content-box sg-content-box--spaced-bottom">
                                <div
                                    ...
                                    <div class="sg-actions-list sg-actions-list--space-between">
                                        <div class="sg-actions-list__hole"><label for="password"
                                                ...
                                                <div class="brn-required-mark">*</div></label></div>
                                        <div class="sg-actions-list__hole"><span
                                                class="sg-text sg-text--xsmall sg-text--link-unstyled sg-text--bold">Tunjukan
                                                password</span></div>
                                    </div>
                            ...
                            <div class="sg-content-box sg-content-box--spaced-bottom">
                                <div class="sg-content-box"><label for="country"
                                        class="sg-text sg-text--xsmall sg-text--bold sg-text--container">Negara<div
                                            class="brn-required-mark">*</div></label></div>
                                <div class="sg-select sg-select--valid sg-select--full-width">
                                    <div class="sg-select__icon"></div><select class="sg-select__element" id="country"
                                        name="country">
                                        ...
                                        <option value="TF">Territoire des Terres australes et antarctiques fr</option>
                            ...
                            <div class="sg-content-box sg-content-box--spaced-bottom">
                                <div class="sg-content-box"><label
                                        class="sg-text sg-text--xsmall sg-text--bold sg-text--container">Tanggal lahir
                                        <div class="brn-required-mark">*</div></label></div>
                            ...
                            <div class="sg-content-box sg-content-box--spaced-top-large"><button disabled=""
                                    class="sg-button-primary sg-button-primary--disabled sg-button-primary--full-width sg-button-primary--dark">Daftar</button>
                            </div>
                        </div>
                    </div>
                </div>
